...
--------------------------------------------------------
--------------------------------------------------------
--  DDL for Package Body XXHTZ_VISIONINV_EXTRACT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "HTZ_CUSTOM"."XXHTZ_VISIONINV_EXTRACT" AS
  /**************************************************************************
  *
					 ...
					 --- initialising bucket variables
                        ...
                        ELSE
                            ...
                            IF v_error_flag <> 'Y' THEN
                                FOR rec_cur_lines IN cur_lines(rec_cur_hdr.invoice_id) LOOP
                                    -- v_err_msg := NULL;
                                    ...
                                    IF (
									  ...
									  -- 5.0
                                               ...
                                               -- || v_vendor_name1
                                                            ...
                                                            v_error_flag := 'Y';
                                                            dbms_output.put_line('Validation for Inv Line number: ' || rec_cur_lines.
                                                            line_number);
                                                            dbms_output.put_line('Error Msg: ' || v_err_msg);
                                                        END IF;
